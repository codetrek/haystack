...
// dotBenchDims spans small/medium/large embedding sizes, with extra points
// (256/320/448/512) bracketing dim=384 to check whether the earlier 11%
// pure-vs-Go-tail gap there was real or a noisy sample.
var dotBenchDims = []int{64, 128, 256, 320, 384, 448, 512, 768, 1536}
...
// BenchmarkDot measures the L1-hot compute ceiling. prod (now the 4-acc kernel)
// and 4Acc_GoTail should match (consistency check); 4Acc_Pure vs 4Acc_GoTail is
// the real question — does moving the fold/tail/reduction into asm help?
